...
final class ApiController extends BaseController
{
    public function health(Request $r,array $p):never
    {
        ...
        Response::json(['status'=>$db==='ok'?'ok':'degraded','version'=>(string)App::$config->get('app_version','1.0.2'),'database'=>$db,'open_food_facts'=>'configured','ai'=>(bool)App::$config->get('ai.enabled',false)?'optional':'off','request_id'=>App::$requestId]);
    }
